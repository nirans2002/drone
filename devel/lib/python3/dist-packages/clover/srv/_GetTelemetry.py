...
class GetTelemetryResponse(genpy.Message):
  _md5sum = "0def052e5171547055856298f5aac1ff"
...
"""
  __slots__ = ['frame_id','connected','armed','mode','x','y','z','lat','lon','alt','vx','vy','vz','roll','pitch','yaw','roll_rate','pitch_rate','yaw_rate','voltage','cell_voltage']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       frame_id,connected,armed,mode,x,y,z,lat,lon,alt,vx,vy,vz,roll,pitch,yaw,roll_rate,pitch_rate,yaw_rate,voltage,cell_voltage
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_3f2d12f().pack(_x.x, _x.y, _x.z, _x.lat, _x.lon, _x.alt, _x.vx, _x.vy, _x.vz, _x.roll, _x.pitch, _x.yaw, _x.roll_rate, _x.pitch_rate, _x.yaw_rate, _x.voltage, _x.cell_voltage))
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.x, _x.y, _x.z, _x.lat, _x.lon, _x.alt, _x.vx, _x.vy, _x.vz, _x.roll, _x.pitch, _x.yaw, _x.roll_rate, _x.pitch_rate, _x.yaw_rate, _x.voltage, _x.cell_voltage,) = _get_struct_3f2d12f().unpack(str[start:end])
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e)  # most likely buffer underfill
...
class GetTelemetry(object):
  ...
  _md5sum = 'd674bf48285301c4b4e5e6f0893fc5e3'
