...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<GetTelemetry-request>)))
  ...
  "d674bf48285301c4b4e5e6f0893fc5e3")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'GetTelemetry-request)))
  "Returns md5sum for a message object of type 'GetTelemetry-request"
  "d674bf48285301c4b4e5e6f0893fc5e3")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<GetTelemetry-response>)))
  ...
  (cl:format cl:nil "string frame_id~%bool connected~%bool armed~%string mode~%float32 x~%float32 y~%float32 z~%float64 lat~%float64 lon~%float32 alt~%float32 vx~%float32 vy~%float32 vz~%float32 roll~%float32 pitch~%float32 yaw~%float32 roll_rate~%float32 pitch_rate~%float32 yaw_rate~%float32 voltage~%float32 cell_voltage~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'GetTelemetry-response)))
  "Returns full string definition for message of type 'GetTelemetry-response"
  (cl:format cl:nil "string frame_id~%bool connected~%bool armed~%string mode~%float32 x~%float32 y~%float32 z~%float64 lat~%float64 lon~%float32 alt~%float32 vx~%float32 vy~%float32 vz~%float32 roll~%float32 pitch~%float32 yaw~%float32 roll_rate~%float32 pitch_rate~%float32 yaw_rate~%float32 voltage~%float32 cell_voltage~%~%~%~%"))
